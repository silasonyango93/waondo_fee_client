...
(function() {
  var f = function(c, b) {
            ...
            if (((a = f[j]), c.isArray(a))) o(b, a);
              ...
              d &&
                ((n = c("<li>", {
                  ...
                  .append(c("<a>", { href: "#" }).html(d))
                  .appendTo(b)),
                g.oApi._fnBindAction(n, { action: a }, k));
            }
        };
      o(
        c(f)
    ...
    b.TableTools &&
      (c.extend(!0, b.TableTools.classes, {
  ...
  "function" === typeof define && define.amd
    ? define(["jquery", "datatables"], f)
    : "object" === typeof exports
    ? f(require("jquery"), require("datatables"))
    : jQuery && f(jQuery, jQuery.fn.dataTable);
})(window, document);
