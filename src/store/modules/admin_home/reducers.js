import {
    ...
    FETCHING_ALL_LOT_DESCRIPTIONS_SUCCESSFUL, FETCHING_ALL_LOTS_NOT_COMPLETED_SCHOOL_SUCCESSFUL,
...
export const ACTION_HANDLERS = {
  ...
  [FETCHING_ALL_ACTUAL_LOTS_SUCCESSFUL]: (state, action) =>
    ...
    [FETCHING_ALL_LOTS_NOT_COMPLETED_SCHOOL_SUCCESSFUL]: (state, action) =>
        Object.assign({}, state, {
            actualLots: { allActualLots: action.payload.allActualLots }
        }),
