...
export const ERROR_OCCURED_WHILE_REGISTERING_USER = "ERROR_OCCURED_WHILE_REGISTERING_USER";


export const USER_SUCCESSFULLY_ASSIGNED_ROLES = "USER_SUCCESSFULLY_ASSIGNED_ROLES";
export const USER_ROLE_ASSIGNMENT_FAILED = "USER_ROLE_ASSIGNMENT_FAILED";
export const ERROR_OCCURED_WHILE_ASSIGNING_USER_ROLES = "ERROR_OCCURED_WHILE_ASSIGNING_USER_ROLES";
...
export const SETUP_FEE_COMPONENT_REGISTRATION_FORM = "SETUP_FEE_COMPONENT_REGISTRATION_FORM";
...
export const RESET_CURRENT_FEE_COMPONENT_CREATED = "RESET_CURRENT_FEE_COMPONENT_CREATED";
