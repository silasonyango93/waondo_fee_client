...
export function fetchAllStudents(areContinuingStudents) {
    return async dispatch => {
        const apiRoute = formatString("/students/fetch_all_students?areContinuingStudents={0}", areContinuingStudents ? 1 : 0);
