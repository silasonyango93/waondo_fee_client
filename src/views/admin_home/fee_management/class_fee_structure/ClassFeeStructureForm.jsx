...
class ClassFeeStructureForm extends Component {
  ...
  handleSubmit = e => {
    ...
    if (!this.state.selectedFeeStructureObject) {
      this.setState({
        selectedFeeStructureHasError: true,
        selectedFeeStructureErrorMessage: "Fee structure is required"
      });
    } else if (!this.state.selectedClassLevelObject) {
      this.setState({
        selectedClassLevelHasError: true,
        selectedClassLevelErrorMessage: "Class is required"
      });
    } else {
      const payload = {
...
const mapDispatchToProps = dispatch => ({
  createClassFeeStructure: payload =>
    dispatch(createClassFeeStructure(payload)),
