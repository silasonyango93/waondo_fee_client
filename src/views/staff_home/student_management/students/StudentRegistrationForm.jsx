  ...
  handleSubmit = event => {
    ...
    if (this.containsANumber(this.state.studentName)) {
      ...
      this.setState({
        ...
        admissionNumberErrorMessage:
          "Admission number must not contain a letter"
      });
    } else if (format.test(this.state.admissionNumber)) {
      this.setState({
        admissionNumberHasError: true,
        admissionNumberErrorMessage:
          "Admission number must not contain special characters"
      });
    } else {
      if (this.state.image) {
...
const mapStateToProps = state => ({
  ...
  studentRegistrationEventMessage:
    state.staff_home.studentRegistration.studentRegistrationEventMessage,
  isStudentSuccessfullyRegistered:
    state.staff_home.studentRegistration.isStudentSuccessfullyRegistered,
